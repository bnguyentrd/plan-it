...
# function that returns the minimum amount of change
...
# For example,
# if you're given coins = [1, 2, 5] ,
# the minimum amount of change that you can't create is 4 .
# If you're given no coins, the minimum amount of change you can't create is 1.

# PSEUDO

Take the two highest numbers 
